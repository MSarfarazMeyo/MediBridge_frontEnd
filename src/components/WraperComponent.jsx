        ...
        <div class="flex w-full flex-col justify-between max-lg:gap-4 lg:flex-row lg:items-center">
          <ul class="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-12">
            <li class="group flex cursor-pointer items-center outline-none">
              ...
              <span class="ml-2 mr-3 text-lg font-normal leading-8 text-indigo-600 transition-all duration-500 group-hover:text-indigo-600">
                Finance
              </span>
              <button class="font-manrope flex aspect-square h-6 items-center justify-center  rounded-full border border-indigo-600 text-base font-medium text-indigo-600  transition-all duration-500 group-hover:border-indigo-600 group-hover:text-indigo-600">
                8
              </button>
            </li>
            ...
            <li class="group flex cursor-pointer items-center outline-none">
              ...
              <span class="pl-2 pr-3 text-lg font-normal leading-8 text-black transition-all duration-500 group-hover:text-indigo-600">
                Management
              </span>
              <span class="font-manrope flex h-6 w-6 items-center justify-center rounded-full border border-gray-900 text-base font-medium text-gray-900 transition-all duration-500 group-hover:border-indigo-600 group-hover:text-indigo-600">
                3
              </span>
            </li>
          ...
          <div class="relative w-full max-w-sm">
            <svg
              class="absolute top-1/2 left-4 z-50 -translate-y-1/2"
              width="20"
              height="20"
              viewBox="0 0 20 20"
              fill="none"
            ...
            <select
              id="Offer"
              class="relative block h-12 w-full appearance-none rounded-full border border-gray-300 bg-white py-2.5 px-4 pl-11 text-base font-normal leading-7 text-gray-900 transition-all duration-500 focus-within:bg-gray-50 hover:border-gray-400 hover:bg-gray-50 focus:outline-none"
            >
            ...
            <svg
              class="absolute top-1/2 right-4 z-50 -translate-y-1/2"
              width="16"
              height="16"
              viewBox="0 0 16 16"
              fill="none"
